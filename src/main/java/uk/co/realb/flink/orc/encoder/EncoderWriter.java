...
public class EncoderWriter<T> {
    ...
    private EncoderWriter(Writer writer, OrcRowEncoder<T> encoder, TypeDescription schema) {
        this.writer = writer;
    ...
    public static class Builder<T> {
        ...
        public EncoderWriter<T> build(){
            return new EncoderWriter<>(writer, encoder, schema);
        }
    }
}
